...
<body class="home-page home-01 ">
										...
										@if(Auth::user()->utype ==='ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													...
													<li class="menu-item">
														<a title="All Orders" href="{{route('admin.contact')}}">Contact</a>
													</li>
													<li class="menu-item">
	...
	<script src="https://cdn.tiny.cloud/1/kcmxt5kxu92f2js7vhhnwai0rbox3b9tjrjcz76y30otlmw8/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>

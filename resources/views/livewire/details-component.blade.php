            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <h2 class="product-name" style="text-transform:uppercase">{{ $product->name }}</h2>
                                ...
                                <div class="row" style="margin-top: 20px">
                                    ...
                                    <div class="col-xs-10">
                                        <select class="form-control" style="width: 200px" wire:model="satt.{{ $av->productAttribute->name }}">
                                            ...
                                            @foreach ($av->productAttribute->attributeValues->where('product_id',$product->id) as $key => $pav)
                                        ...
                                        <ol class="commentlist">
                                            ...
                                            <li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
                                                <div id="comment-20" class="comment_container"> 
                                                    ...
                                                    @else
                                                        <img alt="{{ $orderItem->order->user->name }}" src="{{ asset('assets/images/profile/default.png') }}" height="80" width="80">
                    ...
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem ">
                                ...
                                <div class="product-info">
                                    <a href="{{ route('product.details',['slug'=>$r_product->slug]) }}" class="product-name"><span style="text-transform: uppercase">{{ $r_product->name }}</span></a>

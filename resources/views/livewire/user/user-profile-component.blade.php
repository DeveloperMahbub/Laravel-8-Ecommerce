                ...
                <div class="panel-body">
                    <div class="col-md-3">
                        @if($user->profile->image)
                            <img src="{{asset('assets/images/profile')}}/{{$user->profile->image}}" width="200px" />
                        @else
                            <img src="{{asset('assets/images/profile/default.png')}}" width="200px" />
                        @endif
                    </div>
                    <div class="col-md-9">
                        ...
                        <hr>
                        <p><b>Address 1: </b>{{$user->profile->line1}}</p>
                        <p><b>Address 2: </b>{{$user->profile->line2}}</p>

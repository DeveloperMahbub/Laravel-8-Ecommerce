...
use App\Http\Livewire\Admin\AdminContactComponent as AdminAdminContactComponent;
...
Route::middleware(['auth:sanctum', 'verified','authadmin'])->group(function(){
    ...
    Route::get('/admin/contact',AdminAdminContactComponent::class)->name('admin.contact');
